        ...
        <div class="site-section">
            ...
            <div class="container">
                <form action="MainController" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="h3 mb-3 text-black">Edit Product</h2>
                        </div>
                            ...
                            <div class="p-3 p-lg-5 border">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="id" name="prod-id" value="${product.prod_id}">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="name" name="prod-name" value="${product.prod_name}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="images/${product.image}" width="200" height="200" alt="Image">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div style="width: 300px; height: 300px; overflow: hidden;">
                                        <img id="preview" src="images/${product.image}" alt="Image preview..." style="max-width: 100%; max-height: 100%; display: block;">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="edit product" name="action">
                                </div>
